...
Побіжно зауважимо, що вам може трапитися показник ефективної ізотропно випромінюваної потужності (Effective Isotropic Radiated Power, EIRP), який визначається як :math:`P_t + G_t - L_{cable}` і вимірюється в дБВт.  Додаючи до потужності передавача коефіцієнт підсилення передавальної антени та віднімаючи втрати в кабелі на боці передавача, ми отримуємо зручну величину, яка показує "гіпотетичну" потужність, що її мала б випромінювати ізотропна (ідеально всеспрямована) антена, аби створити таку саму силу сигналу **у напрямку головної пелюстки антени**.  Останню частину виділено не випадково: будь-яка антена з високим підсиленням (:math:`G_t`) дає це високе підсилення лише тоді, коли її правильно спрямовано.  Тож, за умови коректного наведення, EIRP дає все, що потрібно знати про передавальний бік бюджету лінії зв'язку, і саме тому цей показник часто трапляється в технічних характеристиках спрямованих передавачів, як-от супутникових наземних станцій (зазвичай у вигляді "max EIRP").
