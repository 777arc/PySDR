...
Marc is also one of the leads for the `GNU Radio project <https://www.gnuradio.org/>`_, an open source SDR framework widely used in academia and defense.  GNU Radio can be used to implement advanced DSP apps, and a GNU Radio app or individual block is very easy to share with others.
